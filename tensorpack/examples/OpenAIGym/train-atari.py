...
parser.add_argument('--queue_size', help='the size of QueueInputTrainer queue', type=int, default=1)
parser.add_argument('--batch_size', help='batch size', type=int, default=128)
parser.add_argument('--my_sim_master_queue', help='MySimulatorMaster queue size', type=int, default=5)
